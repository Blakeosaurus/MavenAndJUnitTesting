...
public class PirateTest {
    ...
    @Test
    public void plunderVillageTest() {
    	Pirate p1 = new Pirate("Lyd");
    	p1.plunderVillage();
    	p1.plunderVillage();
    	assertEquals(2, p1.getNumVillagesPlundered());
    }
    
    @Test
    public void parrotNameTest() {
    	Pirate pirateHook = new Pirate("Hook", 3);
    	assertEquals("", pirateHook.getParrotName());
    	
    	pirateHook.setParrotName("Squak");
    	assertEquals("Squak", pirateHook.getParrotName());
    }
}
